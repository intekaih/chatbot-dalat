  ...
  template: `
    <div class="bg-white">
      ...
      >
        ...
        <div
          *ngIf="showSort"
          class="absolute right-4 top-24 mt-2 w-48 bg-white border border-gray-200 rounded-2xl shadow-lg z-20 p-2"
        >
          <button
          ...
          >
            ...
            <span *ngIf="selectedSort === option.value" class="ml-auto text-xs"
              >✓</span
            >
          </button>
        </div>
