    ...
    const places = [
      {
        ...
        fullDescription:
          "Hồ Xuân Hương là hồ nước ngọt tự nhiên lớn nhất của thành phố Đà Lạt.",
        imageUrl:
      ...
      },
      {
        ...
        fullDescription:
          "The Married Beans Coffee là một trong những quán cafe được yêu thích nhất Đà Lạt.",
        imageUrl:
      ...
      },
      {
        ...
        fullDescription:
          "Rừng Thông Hai Mộ là khu rừng thông trồng từ thời Pháp thuộc.",
        imageUrl:
      ...
      },
      {
        ...
        fullDescription:
          "Minh Phát là địa chỉ cho thuê xe máy được nhiều du khách tin tưởng.",
        imageUrl:
          "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80",
      ...
      },
      {
        ...
        fullDescription:
          "Dalat Motorbike Rental chuyên cung cấp các dòng xe máy cao cấp.",
        imageUrl:
    ...
    const reviews = [
      {
        ...
        rating: 5,
        content:
          "Cảnh đẹp tuyệt vời! Buổi sáng sớm đi dạo quanh hồ rất thoải mái.",
        helpfulCount: 45,
      },
      {
        id: "review-2",
        ...
        date: "2026-02-15",
        rating: 4,
        content: "Hồ đẹp, nhưng hơi đông vào cuối tuần.",
        helpfulCount: 32,
      },
      {
        id: "review-3",
        ...
        date: "2026-03-05",
        rating: 5,
        content: "Khu vườn hoa rất rộng và đẹp!",
        helpfulCount: 67,
      },
      {
        id: "review-4",
        ...
        date: "2026-03-08",
        rating: 5,
        content: "Quán cafe tuyệt vời! View núi rừng rất đẹp.",
        helpfulCount: 89,
      },
      {
        id: "review-5",
        ...
        date: "2026-03-02",
        rating: 5,
        content: "Khu rừng thông rất huyền bí!",
        helpfulCount: 76,
      },
      {
        id: "review-6",
        ...
        date: "2026-03-06",
        rating: 4,
        content: "Chợ đêm rất nhộn nhịp và có nhiều đồ ăn ngon!",
        helpfulCount: 93,
      },
      {
        id: "review-7",
        ...
        date: "2026-03-03",
        rating: 5,
        content: "Thác nước rất đẹp và trải nghiệm trượt nước rất thú vị!",
        helpfulCount: 71,
      },
    ];

    const insertReview = db.prepare(
      "INSERT INTO reviews (id, place_id, author, date, rating, content, helpful_count) VALUES (?, ?, ?, ?, ?, ?, ?)",
    );
    reviews.forEach((r) => {
      insertReview.run(
        r.id,
